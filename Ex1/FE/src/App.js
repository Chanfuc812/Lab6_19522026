      ...
      <Modal open={open} onClose={() => setOpen(false)}>
        <div style={modalStyle} className={classes.paper}>
          <form className='app_signup'>
            <center>
              <img className='app_headerImage' src='https://logolook.net/wp-content/uploads/2021/11/Shopee-Logo.png' alt='Header'/>
            </center>
          ...
          <form className = "app_signup">
            <center>
              <img className='app_headerImage'
                   src='https://logolook.net/wp-content/uploads/2021/11/Shopee-Logo.png'
                   alt='Header'
              />
            </center>
            <center>
